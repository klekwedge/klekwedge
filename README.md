...
- 🎨 Обожаю улучшать пользовательский интерфейс, делая его удобным и эстетически приятным
- 🚀 Стремлюсь писать чистый и поддерживаемый код, используя TypeScript, ESLint, и Prettier
- 🌱 Активно использую принципы модульности и компонентного подхода для создания масштабируемых приложений
