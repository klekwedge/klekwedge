![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=5000&width=600&lines=Welcome+to+klekwedge's+GitHub+profille!)
...
- ⚛️ Увлечен созданием веб-сайтов с помощью React/Vue
- 🌐️ Мне нравится узнавать о новых технологиях и подходах в веб-разработке
- 📘 Студент Института Компьютерных Наук и Кибебезопасности
- 👨‍💻 Подробнее о моих проектах читайте на моем [сайте](https://klekwedge-cv.vercel.app/) (обновлено 27 февраля)
- 📫 Как со мной связаться: [Linkedin](https://www.linkedin.com/in/klekwedge/) или [Facebook](https://www.facebook.com/klekwedge)
